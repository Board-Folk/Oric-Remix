...
#ifndef Orickeyboard_h
#define Orickeyboard_h
...
#include "WProgram.h"
#endif
#define Oric_KEYMAP_SIZE 	   152 // Size of each array in the key maps

#include "keymapping.h"

#define debug   false     // Set true for serial monitor of Oric keycodes and PS/2 keycodes
...
class Orickeyboard {
  public:
    ...
    static void begin(const OricKeymap_t &map = OricKeymap_main);
};
#endif
